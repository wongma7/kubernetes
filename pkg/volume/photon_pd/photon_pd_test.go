...
func (fake *fakePDManager) CreateVolume(c *photonPersistentDiskProvisioner) (pdID string, volumeSizeGB int, fstype string, mountOptions *string, err error) {
	return "test-photon-pd-id", 10, "ext4", nil, nil
}

...
func (util *CinderDiskUtil) CreateVolume(c *cinderVolumeProvisioner) (volumeID string, volumeSizeGB int, volumeLabels map[string]string, fstype string, mountOptions *string, err error) {
	...
	if c.options.PVC.Spec.Selector != nil {
		return "", 0, nil, "", nil, fmt.Errorf("claim.Spec.Selector is not supported for dynamic provisioning on Cinder")
	}
	...
	return volumeID, volSizeGB, volumeLabels, fstype, mountOptions, nil
}

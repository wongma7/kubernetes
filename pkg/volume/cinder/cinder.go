...
type cdManager interface {
	...
	// Creates a volume
	CreateVolume(provisioner *cinderVolumeProvisioner) (volumeID string, volumeSizeGB int, labels map[string]string, fstype string, mountOptions *string, err error)
	// Deletes a volume

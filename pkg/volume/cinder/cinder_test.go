...
func (fake *fakePDManager) CreateVolume(c *cinderVolumeProvisioner) (volumeID string, volumeSizeGB int, labels map[string]string, fstype string, mountOptions *string, err error) {
	return "test-volume-name", 1, nil, "", nil, nil
}

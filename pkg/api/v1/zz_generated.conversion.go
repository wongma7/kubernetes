...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_PvcCondition_To_api_PvcCondition,
		Convert_api_PvcCondition_To_v1_PvcCondition,
...
func autoConvert_v1_PersistentVolumeClaimStatus_To_api_PersistentVolumeClaimStatus(in *v1.PersistentVolumeClaimStatus, out *api.PersistentVolumeClaimStatus, s conversion.Scope) error {
	...
	out.AccessModes = *(*[]api.PersistentVolumeAccessMode)(unsafe.Pointer(&in.AccessModes))
	out.Capacity = *(*api.ResourceList)(unsafe.Pointer(&in.Capacity))
	out.Conditions = *(*[]api.PvcCondition)(unsafe.Pointer(&in.Conditions))
	return nil
}
...
func autoConvert_api_PersistentVolumeClaimStatus_To_v1_PersistentVolumeClaimStatus(in *api.PersistentVolumeClaimStatus, out *v1.PersistentVolumeClaimStatus, s conversion.Scope) error {
	...
	out.AccessModes = *(*[]v1.PersistentVolumeAccessMode)(unsafe.Pointer(&in.AccessModes))
	out.Capacity = *(*v1.ResourceList)(unsafe.Pointer(&in.Capacity))
	out.Conditions = *(*[]v1.PvcCondition)(unsafe.Pointer(&in.Conditions))
	return nil
}
...
func autoConvert_v1_PvcCondition_To_api_PvcCondition(in *v1.PvcCondition, out *api.PvcCondition, s conversion.Scope) error {
	out.Type = api.PvcConditionType(in.Type)
	out.Status = api.ConditionStatus(in.Status)
	out.LastProbeTime = in.LastProbeTime
	out.LastTransitionTime = in.LastTransitionTime
	out.Reason = in.Reason
...
// Convert_v1_PvcCondition_To_api_PvcCondition is an autogenerated conversion function.
func Convert_v1_PvcCondition_To_api_PvcCondition(in *v1.PvcCondition, out *api.PvcCondition, s conversion.Scope) error {
	return autoConvert_v1_PvcCondition_To_api_PvcCondition(in, out, s)
}

func autoConvert_api_PvcCondition_To_v1_PvcCondition(in *api.PvcCondition, out *v1.PvcCondition, s conversion.Scope) error {
	out.Type = v1.PvcConditionType(in.Type)
	out.Status = v1.ConditionStatus(in.Status)
	out.LastProbeTime = in.LastProbeTime
	out.LastTransitionTime = in.LastTransitionTime
	out.Reason = in.Reason
...
// Convert_api_PvcCondition_To_v1_PvcCondition is an autogenerated conversion function.
func Convert_api_PvcCondition_To_v1_PvcCondition(in *api.PvcCondition, out *v1.PvcCondition, s conversion.Scope) error {
	return autoConvert_api_PvcCondition_To_v1_PvcCondition(in, out, s)
}

...
type CSINodeInfoInterface interface {
	Create(*v1beta1.CSINodeInfo) (*v1beta1.CSINodeInfo, error)
	Update(*v1beta1.CSINodeInfo) (*v1beta1.CSINodeInfo, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.CSINodeInfo, error)
	List(opts v1.ListOptions) (*v1beta1.CSINodeInfoList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.CSINodeInfo, err error)
...
func newCSINodeInfos(c *CsiV1beta1Client) *cSINodeInfos {
	return &cSINodeInfos{
		client: c.RESTClient(),
	}
}
...
func (c *cSINodeInfos) Get(name string, options v1.GetOptions) (result *v1beta1.CSINodeInfo, err error) {
	result = &v1beta1.CSINodeInfo{}
	err = c.client.Get().
...
func (c *cSINodeInfos) List(opts v1.ListOptions) (result *v1beta1.CSINodeInfoList, err error) {
	result = &v1beta1.CSINodeInfoList{}
	err = c.client.Get().
		Resource("csinodeinfos").
...
func (c *cSINodeInfos) Create(cSINodeInfo *v1beta1.CSINodeInfo) (result *v1beta1.CSINodeInfo, err error) {
	result = &v1beta1.CSINodeInfo{}
	err = c.client.Post().
		Resource("csinodeinfos").
		Body(cSINodeInfo).
...
func (c *cSINodeInfos) Update(cSINodeInfo *v1beta1.CSINodeInfo) (result *v1beta1.CSINodeInfo, err error) {
	result = &v1beta1.CSINodeInfo{}
	err = c.client.Put().
		Resource("csinodeinfos").
...
func (c *cSINodeInfos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.CSINodeInfo, err error) {
	result = &v1beta1.CSINodeInfo{}

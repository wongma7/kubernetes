...
var map_PersistentVolumeSpec = map[string]string{
	...
	"mountOptions":                  "A comma-separated list of mount options. Not validated--mount will simply fail if one is invalid. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes/#mount-options",
}
